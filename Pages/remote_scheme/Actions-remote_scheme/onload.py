...
try:
	...
	if session.get("from_license_page") and session.get("from_license_page") == "1":
		self.button_license.visible = "1"
		self.button_license.text = lang["license_button"]
